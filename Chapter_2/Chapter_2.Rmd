...
```{r}
knitr::include_graphics("29.png",dpi = "100px")
...
--
Question: On average, will the $\widehat{\beta_{1}}$ be equal to the true parameter $\beta_{1}$ if  we repeatedly sample?
...
```{r}
knitr::include_graphics("2c.png",dpi = "100px")

```


```{r}
knitr::include_graphics("2d.png",dpi = "100px")
